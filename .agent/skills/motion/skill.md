---
name: motion
description: Build React animations with Motion (Framer Motion) - gestures (drag, hover, tap), scroll effects, spring physics, layout animations, and SVG.
activation: Read this file when implementing complex animations, drag-and-drop, scroll-linked effects, or layout transitions in React/Next.js.
