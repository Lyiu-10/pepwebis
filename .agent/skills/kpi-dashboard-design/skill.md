...
activation: Read this file when building business dashboards, selecting metrics, or designing data visualization layouts (e.g., ECharts, Chart.js, Recharts, Streamlit).
